...
typedef enum{
	...
	*@brief : Everything NOT Ok, Function had Performed Incorrectly.
    ...
    NVIC_enumNOK,
    /**
	*@brief : Select Interrupt Number not exist.
	 */
    NVIC_enumWrongIntNum,
    /**
	*@brief : Send NULL Pointer .
	 */
    NVIC_enumNullPointer,
...
/********************************************************************************************************/
/*
*@brief:Function to Enable a specific interrupt
*@param: interrupt number
*@return: Error State
*/
NVIC_ERROR_t NVIC_EnableInterrupt(u32 intNum);
/*
*@brief:Function to Disable a specific interrupt
*@param: interrupt number
*@return: Error State
*/
NVIC_ERROR_t NVIC_DisableInterrupt(u32 intNum);
/*
*@brief:Function to Set Priority to a specific interrupt
*@param: interrupt number
*@return: Error State
*/
NVIC_ERROR_t NVIC_SetPriority(u8 intNum,u8 priority);
/*
*@brief:Function to Get Priority of a specific interrupt
*@param: interrupt number
*@return: Error State
*/
NVIC_ERROR_t NVIC_SetSubPriority(u8 intNum,u8 subGroup,u8 Preemption,u8 subGroupbits );
/*
*@brief:Function to Set Pinding bit of a specific interrupt
*@param: interrupt number
*@return: Error State
*/
NVIC_ERROR_t NVIC_SetPending(u32 intNum);
/*
*@brief:Function to Clear Pinding bit of a specific interrupt
*@param: interrupt number
*@return: Error State
*/
NVIC_ERROR_t NVIC_ClearPending(u32 intNum);
/*
*@brief:Function to Get the active state of a specific interrupt
*@param: interrupt number and Pointer to Variable that carries the value of state
*@return:Error State
*/
